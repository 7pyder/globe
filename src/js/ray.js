...
var RayController = function (_EventEmitter) {
  ...
  _createClass(RayController, [{
    ...
    value: function updatePointer_(e) {
      ...
      this.pointerNdc.x = ((e.clientX - this.el.getBoundingClientRect().left) / this.size.width) * 2 - 1;
			this.pointerNdc.y = - ((e.clientY - this.el.getBoundingClientRect().top) / this.size.height) * 2 + 1;
    }
  }, {
